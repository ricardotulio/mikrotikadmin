...
<link rel="stylesheet"
	href="<c:url value="/assets/css/skins/_all-skins.min.css" />">
<!-- iCheck -->
<link rel="stylesheet"
	href="<c:url value="/assets/plugins/iCheck/flat/blue.css" />">
<!-- Morris chart -->
<link rel="stylesheet"
	href="<c:url value="/assets/plugins/morris/morris.css" />">
<!-- jvectormap -->
<link rel="stylesheet"
	href="<c:url value="/assets/plugins/jvectormap/jquery-jvectormap-1.2.2.css" />">
<!-- Date Picker -->
<link rel="stylesheet"
	href="<c:url value="/assets/plugins/datepicker/css/bootstrap-datepicker.css" />">
<!-- Daterange picker -->
<link rel="stylesheet"
	href="<c:url value="/assets/plugins/daterangepicker/daterangepicker-bs3.css" />">
			...
			<ul class="nav navbar-nav">
							...
							<ul class="menu">
								<li>
									<!-- start message --> <a href="#">
										<div class="pull-left">
											<img src="<c:url value="/assets/img/user2-160x160.jpg" />"
								...
								<li><a href="#">
										<div class="pull-left">
											<img src="<c:url value="/assets/img/user3-128x128.jpg" />"
												class="img-circle" alt="User Image">
										</div>
										<h4>
								...
								<li><a href="#">
										<div class="pull-left">
											<img src="<c:url value="/assets/img/user4-128x128.jpg" />"
												class="img-circle" alt="User Image">
										</div>
										<h4>
								...
								<li><a href="#">
										<div class="pull-left">
											<img src="<c:url value="/assts/img/user3-128x128.jpg" />"
												class="img-circle" alt="User Image">
										</div>
										<h4>
				...
				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img
						src="<c:url value="/assets/img/user2-160x160.jpg" />"
