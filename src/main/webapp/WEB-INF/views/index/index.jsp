		...
		<section class="col-lg-7 connectedSortable">
			...
			<div class="box box-success">
				...
				<div class="box-body chat" id="chat-box">
					<!-- chat item -->
					<div class="item">
                    	<img src="<c:url value="assets/img/user4-128x128.jpg" />" alt="user image" class="online">
						<p class="message">
					...
					<!-- chat item -->
					<div class="item">
						<img src="<c:url value="assets/img/user3-128x128.jpg" />" alt="user image"
							class="offline">
						<p class="message">
							<a href="#" class="name"> <small
								class="text-muted pull-right"><i class="fa fa-clock-o"></i>
					...
					<!-- chat item -->
					<div class="item">
						<img src="<c:url value="assets/img/user2-160x160.jpg" />" alt="user image"
							class="offline">
						<p class="message">
							<a href="#" class="name"> <small
								class="text-muted pull-right"><i class="fa fa-clock-o"></i>
				...
				<div class="box-body">
					<ul class="todo-list">
						...
						<li><span class="handle"> <i class="fa fa-ellipsis-v"></i>
							...
							class="label label-info"><i class="fa fa-clock-o"></i> 4
								hours</small>
							<div class="tools">
								<i class="fa fa-edit"></i> <i class="fa fa-trash-o"></i>
							</div></li>
