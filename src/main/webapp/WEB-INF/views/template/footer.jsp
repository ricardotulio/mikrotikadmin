...
<!-- Sparkline -->
<script
	src="<c:url value="/assets/plugins/sparkline/jquery.sparkline.min.js" />"></script>
<!-- jvectormap -->
<script
	src="<c:url value="/assets/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js" />"></script>
<script
	src="<c:url value="/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js" />"></script>
<!-- jQuery Knob Chart -->
...
<script
	src="<c:url value="/assets/plugins/daterangepicker/daterangepicker.js" />"></script>
<!-- datepicker -->
<script
	src="<c:url value="/assets/plugins/datepicker/js/bootstrap-datepicker.js" />"></script>
<!-- datepicker locale -->
<script
	src="<c:url value="/assets/plugins/datepicker/locales/bootstrap-datepicker.pt-BR.min.js" />"></script>	
<!-- Bootstrap WYSIHTML5 -->
<script
	src="<c:url value="/assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"/>"></script>
<!-- Slimscroll -->
<script
	src="<c:url value="/assets/plugins/slimScroll/jquery.slimscroll.min.js" />"></script>
<!-- FastClick -->
<script
	src="<c:url value="/assets/plugins/fastclick/fastclick.min.js" />"></script>
<!-- AdminLTE App -->
